...
<div class="header_small">
        <span id="sin"><a href="login.php">Sign In</a></span>
        <span id="sup"><a href="Reg.php">Sign Up</a></span>
      </div>
      <div id="header">
      ...
      <ul>
        ...
        <li class="tutorials"><a href="#">Where to go</a>
          <ul>
            ...
            ?>
            <!--<li><a href="Dhaka.php?place='Khulna'">Khulna</a></li>
            <li><a href="Dhaka.php?place='Chittagong'">Chittagong</a></li>-->
          </ul>
        </li>
