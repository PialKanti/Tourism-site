...
<head>
  <title></title>
  <link rel="stylesheet" type="text/css" href="CSS/User_home_header.css">
</head>
<body>
<div class="header_small">
        <span id="welcome_msg"><?php echo "Hello"."  ".$_COOKIE['Remember_me']; ?></span>
        <span id="User"><a href="UserPage.php"><b><?php echo $_COOKIE['Remember_me'] ?></b></a></span>
...
<div class="nav">
      <ul>
        ...
        <li class="tutorials"><a href="about_Bangladesh.php">Where to go</a>
          <ul>
            <?php
        ...
        <li class="about"><a class="active" href="#">About Bangladesh</a></li>
