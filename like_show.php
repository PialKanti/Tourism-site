...
$q="INSERT INTO like_record(comment_id,username) VALUES ('$comment_id','$user') ";
mysql_query($q);

$sql="SELECT likes FROM comment WHERE (comment_id='$comment_id')";
$result=mysql_query($sql) or die(mysql_error());
$row=mysql_fetch_array($result);
$count=$row['likes'];
$count++;
$s="UPDATE comment SET likes='$count' WHERE (comment_id='$comment_id')";
